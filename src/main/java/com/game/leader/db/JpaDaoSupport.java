...
@Transactional(value = "gameTM")
public class JpaDaoSupport {

	@PersistenceContext(unitName = "gameEntityManagerFactory")
	protected EntityManager entityManager;

	/**
	 * Cree la requete et applique les conditions de limite / offset et retourne
	 * la {@link TypedQuery} correspondante.
	 * 
	 * @param <T>
	 *            le type de l'entite retournee
	 * @param criteria
	 * @param limit
	 *            null si pas de limite
	 * @param offset
	 *            null si pas d'offset
